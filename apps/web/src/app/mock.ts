export const mockCards: any[] = [
    ...
    },
    {
      ...
      emojis: [
        { type: 'poop', count: 8, icon: 'https://public.yourware.so/emoji/poop.svg' },
        { type: 'clap', count: 5, icon: 'https://public.yourware.so/emoji/clap.svg' }
      ],
      views: 267,
      remixCount: 2,
      isOriginal: false
    },
    {
      ...
      emojis: [
        { type: '100', count: 12, icon: 'https://public.yourware.so/emoji/100.svg' },
    ...
    },
    {
      ...
      emojis: [
        { type: '100', count: 6, icon: 'https://public.yourware.so/emoji/100.svg' },
        { type: 'poop', count: 9, icon: 'https://public.yourware.so/emoji/poop.svg' }
      ],
      views: 345,
      remixCount: 1,
      isOriginal: false
    },
    {
      ...
      emojis: [
        { type: 'clap', count: 15, icon: 'https://public.yourware.so/emoji/clap.svg' },
